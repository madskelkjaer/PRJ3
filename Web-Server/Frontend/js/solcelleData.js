...
const updateWSData = (message_data) => {
	...
	message_data.sun_up == 1
		? up.classList.add("sun-active")
		: up.classList.remove("sun-active");
	message_data.sun_down == 1
		? down.classList.add("sun-active")
		: down.classList.remove("sun-active");
	message_data.sun_left == 1
		? left.classList.add("sun-active")
		: left.classList.remove("sun-active");
	message_data.sun_right == 1
		? right.classList.add("sun-active")
		: right.classList.remove("sun-active");
};
