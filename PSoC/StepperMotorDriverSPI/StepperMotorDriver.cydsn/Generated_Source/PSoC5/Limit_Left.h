...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Limit_Left_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Limit_Left__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Limit_Left_SetInterruptMode() function.
     *  @{
     */
        #define Limit_Left_INTR_NONE      (uint16)(0x0000u)
        #define Limit_Left_INTR_RISING    (uint16)(0x0001u)
        #define Limit_Left_INTR_FALLING   (uint16)(0x0002u)
        #define Limit_Left_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Limit_Left_INTR_MASK      (0x01u) 
#endif /* (Limit_Left__INTSTAT) */
...
/* SIO registers */
#if defined(Limit_Left__SIO_CFG)
    #define Limit_Left_SIO_HYST_EN        (* (reg8 *) Limit_Left__SIO_HYST_EN)
    #define Limit_Left_SIO_REG_HIFREQ     (* (reg8 *) Limit_Left__SIO_REG_HIFREQ)
    #define Limit_Left_SIO_CFG            (* (reg8 *) Limit_Left__SIO_CFG)
    #define Limit_Left_SIO_DIFF           (* (reg8 *) Limit_Left__SIO_DIFF)
#endif /* (Limit_Left__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Limit_Left_0_INTTYPE_REG 		(* (reg8 *) Limit_Left__0__INTTYPE)
#endif /* (Limit_Left__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_Limit_Left_H */
