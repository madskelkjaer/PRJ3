...
*
* \funcusage
*  \snippet Limit_Right_SUT.c usage_Limit_Right_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Limit_Right_SUT.c usage_Limit_Right_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Limit_Right_SUT.c usage_Limit_Right_Read  
*******************************************************************************/
...
* preferred Limit_Right_Read() API because the 
* Limit_Right_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Limit_Right_SUT.c usage_Limit_Right_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Limit_Right_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Limit_Right_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Limit_Right_0_INTR       (First pin in the list)
    *  - Limit_Right_1_INTR       (Second pin in the list)
    *  - ...
    *  - Limit_Right_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Limit_Right_SUT.c usage_Limit_Right_SetInterruptMode
    *******************************************************************************/
    void Limit_Right_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Limit_Right_0_INTR) != 0u) 
		{ 
			 Limit_Right_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Limit_Right_SUT.c usage_Limit_Right_ClearInterrupt
    *******************************************************************************/
