// ======================================================================
// Dataindsamling.v generated from TopDesign.cysch
// 05/22/2024 at 12:26
...
module ADC_SAR_v3_10_1 (
	...
	cy_clock_v1_0
		#(.id("31459baf-30c5-4d4a-8faf-a74e5720aa69/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__WAM_net;
	wire [0:0] tmpFB_0__WAM_net;
	wire [0:0] tmpIO_0__WAM_net;
	wire [0:0] tmpINTERRUPT_0__WAM_net;
	electrical [0:0] tmpSIOVREF__WAM_net;
	...
	cy_psoc3_pins_v1_10
		...
		WAM
		 (.oe(tmpOE__WAM_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__WAM_net[0:0]}),
		  .analog({Net_7}),
		  .io({tmpIO_0__WAM_net[0:0]}),
		  .siovref(tmpSIOVREF__WAM_net),
		  .interrupt({tmpINTERRUPT_0__WAM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__WAM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__SolarPanel_net;
	wire [0:0] tmpFB_0__SolarPanel_net;
	wire [0:0] tmpIO_0__SolarPanel_net;
	wire [0:0] tmpINTERRUPT_0__SolarPanel_net;
	electrical [0:0] tmpSIOVREF__SolarPanel_net;

	cy_psoc3_pins_v1_10
		#(.id("888c91ba-b7bc-4788-bff0-ece52ecc2eb1"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SolarPanel
		 (.oe(tmpOE__SolarPanel_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SolarPanel_net[0:0]}),
		  .analog({Net_14}),
		  .io({tmpIO_0__SolarPanel_net[0:0]}),
		  .siovref(tmpSIOVREF__SolarPanel_net),
		  .interrupt({tmpINTERRUPT_0__SolarPanel_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SolarPanel_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("562547f4-17ac-42a2-9c77-cffb094f19dc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
