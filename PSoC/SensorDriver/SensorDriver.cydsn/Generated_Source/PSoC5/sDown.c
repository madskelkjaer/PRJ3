...
*
* \funcusage
*  \snippet sDown_SUT.c usage_sDown_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet sDown_SUT.c usage_sDown_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet sDown_SUT.c usage_sDown_Read  
*******************************************************************************/
...
* preferred sDown_Read() API because the 
* sDown_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet sDown_SUT.c usage_sDown_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: sDown_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use sDown_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - sDown_0_INTR       (First pin in the list)
    *  - sDown_1_INTR       (Second pin in the list)
    *  - ...
    *  - sDown_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet sDown_SUT.c usage_sDown_SetInterruptMode
    *******************************************************************************/
    void sDown_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & sDown_0_INTR) != 0u) 
		{ 
			 sDown_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet sDown_SUT.c usage_sDown_ClearInterrupt
    *******************************************************************************/
